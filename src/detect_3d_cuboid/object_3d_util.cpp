...
// pixels  2*n; each column is a pt [x;y] x is horizontal,y is vertical   outputs: pts3d 3*n in world frame
{
    ...
    // std::cout << "pts_3d_sensor" << std::endl;
    // std::cout << pts_3d_sensor << std::endl;


    pts_3d_world = homo_to_real_coord<double>(transToWolrd * real_to_homo_coord<double>(pts_3d_sensor)); // projection


    // std::cout << "pts_3d_sensor_after" << std::endl;
    // std::cout << pts_3d_sensor << std::endl;
                                   ...
                                   cuboid &sample_obj)
{
    ...
    // std::cout<<"transToworld"<<std::endl;
    // std::cout<<transToWolrd<<std::endl;
    // std::cout<<"invK"<<std::endl;
    // std::cout<<invK<<std::endl;
    // std::cout<<"ground palne"<<std::endl;
    // std::cout<<ground_plane_sensor<<std::endl;
    // std::cout<<"2d corner"<<std::endl;
    // std::cout<<box_corners_2d_float<<std::endl;

    plane_hits_3d(transToWolrd, invK, ground_plane_sensor, box_corners_2d_float.rightCols(4), obj_gnd_pt_world_3d); //% 3*n each column is a 3D point  floating point, bc2f: top 4 2d points of cuboid 
    //plane_hits_3d(transToWolrd, invK, ground_plane_sensor, box_corners_2d_float.leftCols(4), obj_gnd_pt_world_3d); //% 3*n each column is a 3D point  floating point, bc2f: top 4 2d points of cuboid 
    ...
    //plane_hits_3d(transToWolrd, invK, partwall_plane_sensor, box_corners_2d_float.col(5), obj_top_pt_world_3d); // should match obj_gnd_pt_world_3d  % compute corner 2
